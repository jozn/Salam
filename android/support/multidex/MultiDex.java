...
public final class MultiDex {
    ...
    private static final class V14 {
        ...
        private static Object[] makeDexElements(Object dexPathList, ArrayList<File> files, File optimizedDirectory) throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
            ...
            Method access$500 = MultiDex.findMethod(dexPathList, "makeDexElements", clsArr);
            ...
            return (Object[]) access$500.invoke(dexPathList, objArr);
        }
    }
    ...
    private static ApplicationInfo getApplicationInfo(Context context) throws NameNotFoundException {
        try {
            ...
            return pm.getApplicationInfo(packageName, AccessibilityNodeInfoCompat.ACTION_CLEAR_ACCESSIBILITY_FOCUS);
        } catch (RuntimeException e) {
        ...
        if (versionString != null) {
            ...
            if (matcher.matches()) {
                try {
                    ...
                    isMultidexCapable = (major > VM_WITH_MULTIDEX_VERSION_MAJOR || (major == VM_WITH_MULTIDEX_VERSION_MAJOR && Integer.parseInt(matcher.group(VM_WITH_MULTIDEX_VERSION_MAJOR)) > 0)) ? true : IS_VM_MULTIDEX_CAPABLE;
