...
public class RemoteInput extends android.support.v4.app.RemoteInputCompatBase.RemoteInput {
    ...
    static class C00241 implements Factory {
        ...
        public final RemoteInput build(String resultKey, CharSequence label, CharSequence[] choices, boolean allowFreeFormInput, Bundle extras) {
            return new RemoteInput(resultKey, label, choices, allowFreeFormInput, extras);
        }

        public final RemoteInput[] newArray(int size) {
    ...
    public static final class Builder {
        ...
        public final Builder setChoices(CharSequence[] choices) {
            this.mChoices = choices;
            return this;
        }

        public final Builder setAllowFreeFormInput(boolean allowFreeFormInput) {
