...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflaterFactory {
    ...
    public final void removeOnBackStackChangedListener(OnBackStackChangedListener listener) {
        if (this.mBackStackChangeListeners != null) {
    ...
    final Animation loadAnimation(Fragment fragment, int transit, boolean enter, int transitionStyle) {
    ...
    final void moveToState(android.support.v4.app.Fragment r12, int r13, int r14, int r15, boolean r16) {
        /*
        r11 = this;
        r0 = r12.mAdded;
    ...
    final void moveToState(Fragment f) {
        moveToState(f, this.mCurState, 0, 0, HONEYCOMB);
    }
    ...
    final void moveToState(int newState, int transit, int transitStyle, boolean always) {
    ...
    final void makeInactive(Fragment f) {
        if (f.mIndex >= 0) {
            if (DEBUG) {
    ...
    public final void setBackStackIndex(int index, BackStackRecord bse) {
        synchronized (this) {
            if (this.mBackStackIndices == null) {
                this.mBackStackIndices = new ArrayList();
            }
    ...
    public final void freeBackStackIndex(int index) {
        synchronized (this) {
    ...
    final void addBackStackState(BackStackRecord state) {
        if (this.mBackStack == null) {
    ...
    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    final boolean popBackStackState(android.os.Handler r13, java.lang.String r14, int r15, int r16) {
        /*
        r12 = this;
        r9 = r12.mBackStack;
    ...
    final void saveFragmentViewState(Fragment f) {
    ...
    final Bundle saveFragmentBasicState(Fragment f) {
        Bundle result = null;
    ...
    final void restoreAllState(Parcelable state, List<Fragment> nonConfig) {
        if (state != null) {
