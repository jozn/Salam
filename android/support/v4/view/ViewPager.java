...
public class ViewPager extends ViewGroup {
    ...
    static class C01001 implements Comparator<ItemInfo> {
        ...
        public final int compare(ItemInfo lhs, ItemInfo rhs) {
    ...
    public static class SavedState extends BaseSavedState {
        ...
        static class C01031 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C01031() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C01031());
        }
    ...
    void smoothScrollTo(int x, int y, int velocity) {
        ...
        if (velocity > 0) {
            ...
            duration = (int) (((((float) Math.abs(dx)) / (((float) this.mPageMargin) + (((float) width) * this.mAdapter.getPageWidth(this.mCurItem)))) + 1.0f) * 100.0f);
        }
    ...
    L_0x0095:
        r26 = r29.getResources();	 Catch:{ NotFoundException -> 0x00f8 }
        r27 = r29.getId();	 Catch:{ NotFoundException -> 0x00f8 }
        r23 = r26.getResourceName(r27);	 Catch:{ NotFoundException -> 0x00f8 }
    L_0x00a1:
    ...
    private void recomputeScrollPosition(int width, int oldWidth, int margin, int oldMargin) {
        ...
        int newOffsetPixels = (int) ((((float) getScrollX()) / ((float) (((oldWidth - getPaddingLeft()) - getPaddingRight()) + oldMargin))) * ((float) (((width - getPaddingLeft()) - getPaddingRight()) + margin)));
            ...
            if (this.mAdapter.getCount() != 0) {
                ...
                switch (action & MotionEventCompat.ACTION_MASK) {
                    ...
                    case SCROLL_STATE_SETTLING /*2*/:
                        ...
                        if (this.mIsBeingDragged) {
                            needsInvalidate = performDrag(MotionEventCompat.getX(ev, MotionEventCompat.findPointerIndex(ev, this.mActivePointerId))) | SCROLL_STATE_IDLE;
                            break;
                        }
                        break;
                    case Logger.INFO /*3*/:
    ...
    public void draw(Canvas canvas) {
        ...
        if (overScrollMode == 0 || (overScrollMode == SCROLL_STATE_DRAGGING && this.mAdapter != null && this.mAdapter.getCount() > SCROLL_STATE_DRAGGING)) {
            ...
            if (!this.mLeftEdge.isFinished()) {
                ...
                needsInvalidate = this.mLeftEdge.draw(canvas) | SCROLL_STATE_IDLE;
