...
class ViewPropertyAnimatorCompatKK {
    ...
    static class C01071 implements AnimatorUpdateListener {
        final /* synthetic */ ViewPropertyAnimatorUpdateListener val$listener;
        final /* synthetic */ View val$view;

        C01071(ViewPropertyAnimatorUpdateListener viewPropertyAnimatorUpdateListener, View view) {
    ...
    public static void setUpdateListener(View view, ViewPropertyAnimatorUpdateListener listener) {
        ...
        if (listener != null) {
            wrapped = new C01071(listener, view);
        }
