...
*/
        ...
        r6 = 0;
        r1 = 1;
        r2 = new java.lang.String[r1];	 Catch:{ Exception -> 0x0024, all -> 0x003e }
        r1 = 0;	 Catch:{ Exception -> 0x0024, all -> 0x003e }
        r3 = "document_id";	 Catch:{ Exception -> 0x0024, all -> 0x003e }
        r2[r1] = r3;	 Catch:{ Exception -> 0x0024, all -> 0x003e }
        r3 = 0;	 Catch:{ Exception -> 0x0024, all -> 0x003e }
        r4 = 0;	 Catch:{ Exception -> 0x0024, all -> 0x003e }
        r5 = 0;	 Catch:{ Exception -> 0x0024, all -> 0x003e }
        r1 = r11;	 Catch:{ Exception -> 0x0024, all -> 0x003e }
        r6 = r0.query(r1, r2, r3, r4, r5);	 Catch:{ Exception -> 0x0024, all -> 0x003e }
        r1 = r6.getCount();	 Catch:{ Exception -> 0x0024, all -> 0x003e }
    ...
    L_0x0024:
        r7 = move-exception;
        r1 = "DocumentFile";	 Catch:{ Exception -> 0x0024, all -> 0x003e }
        r2 = new java.lang.StringBuilder;	 Catch:{ Exception -> 0x0024, all -> 0x003e }
        r3 = "Failed query: ";	 Catch:{ Exception -> 0x0024, all -> 0x003e }
        r2.<init>(r3);	 Catch:{ Exception -> 0x0024, all -> 0x003e }
        r2 = r2.append(r7);	 Catch:{ Exception -> 0x0024, all -> 0x003e }
        r2 = r2.toString();	 Catch:{ Exception -> 0x0024, all -> 0x003e }
        android.util.Log.w(r1, r2);	 Catch:{ Exception -> 0x0024, all -> 0x003e }
        closeQuietly(r6);
        r1 = r9;
        goto L_0x0021;
    L_0x003e:
