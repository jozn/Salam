...
public final class BidiFormatter {
    ...
    public static final class Builder {
        ...
        public final Builder stereoReset(boolean stereoReset) {
            if (stereoReset) {
                this.mFlags |= BidiFormatter.FLAG_STEREO_RESET;
            } else {
                this.mFlags &= -3;
        ...
        public final Builder setTextDirectionHeuristic(TextDirectionHeuristicCompat heuristic) {
    ...
    public final String unicodeWrap(String str, TextDirectionHeuristicCompat heuristic, boolean isolate) {
        if (str == null) {
            return null;
        }
        boolean isRtl = heuristic.isRtl((CharSequence) str, (int) DIR_UNKNOWN, str.length());
    ...
    public final String unicodeWrap(String str, TextDirectionHeuristicCompat heuristic) {
        return unicodeWrap(str, heuristic, true);
    }

    public final String unicodeWrap(String str, boolean isolate) {
