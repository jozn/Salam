...
final class SwipeProgressBar {
    ...
    final void setColorScheme(int color1, int color2, int color3, int color4) {
        this.mColor1 = color1;
        this.mColor2 = color2;
        this.mColor3 = color3;
        this.mColor4 = color4;
    ...
    final void setTriggerPercentage(float triggerPercentage) {
    ...
    final void draw(Canvas canvas) {
        ...
        if (this.mRunning || this.mFinishTime > 0) {
            ...
            if (!this.mRunning) {
                ...
                float clearRadius = ((float) cx) * INTERPOLATOR.getInterpolation((((float) ((now - this.mFinishTime) % 1000)) / 10.0f) / 100.0f);
