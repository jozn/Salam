...
public final class MediaMetadataCompat implements Parcelable {
    ...
    static class C00521 implements Creator<MediaMetadataCompat> {
        C00521() {
        }

        public final MediaMetadataCompat createFromParcel(Parcel in) {
            return new MediaMetadataCompat(null);
        }

        public final MediaMetadataCompat[] newArray(int size) {
    ...
    public static final class Builder {
        ...
        public final Builder putText(String key, CharSequence value) {
        ...
        public final Builder putRating(String key, RatingCompat value) {
        ...
        public final Builder putBitmap(String key, Bitmap value) {
    ...
    public final CharSequence getText(String key) {
    ...
    public final RatingCompat getRating(String key) {
    ...
    public final MediaDescriptionCompat getDescription() {
        ...
        if (TextUtils.isEmpty(displayText)) {
            ...
            while (textIndex < METADATA_TYPE_RATING && keyIndex < PREFERRED_DESCRIPTION_ORDER.length) {
                int textIndex2;
                ...
                if (TextUtils.isEmpty(next)) {
                    ...
                    textIndex2 = textIndex + METADATA_TYPE_TEXT;
                    text[textIndex] = next;
                }
                keyIndex = keyIndex2;
