...
public final class MediaDescriptionCompat implements Parcelable {
    ...
    static class C00511 implements Creator<MediaDescriptionCompat> {
        C00511() {
        }

        public final MediaDescriptionCompat createFromParcel(Parcel in) {
        ...
        public final MediaDescriptionCompat[] newArray(int size) {
    ...
    public static final class Builder {
        ...
        public final Builder setMediaId(@Nullable String mediaId) {
        ...
        public final Builder setIconBitmap(@Nullable Bitmap icon) {
            this.mIcon = icon;
            return this;
        }

        public final Builder setIconUri(@Nullable Uri iconUri) {
        ...
        public final Builder setMediaUri(@Nullable Uri mediaUri) {
