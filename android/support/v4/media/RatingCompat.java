...
public final class RatingCompat implements Parcelable {
    ...
    static class C00531 implements Creator<RatingCompat> {
        C00531() {
        }

        public final RatingCompat createFromParcel(Parcel p) {
            return new RatingCompat(p.readFloat(), null);
        }

        public final RatingCompat[] newArray(int size) {
    ...
    public final boolean hasHeart() {
        if (this.mRatingStyle == RATING_HEART && this.mRatingValue == 1.0f) {
            return true;
        }
        return false;
    }
