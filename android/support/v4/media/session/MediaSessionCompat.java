...
public class MediaSessionCompat {
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        class C00661 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C00661() {
            }
            ...
            private void onMediaButtonEvent(KeyEvent ke) {
                ...
                if (ke != null && ke.getAction() == 0) {
                    ...
                    switch (ke.getKeyCode()) {
                        ...
                        case C0170R.styleable.Theme_colorControlHighlight /*87*/:
                            if ((32 & validActions) != 0) {
                                MediaSessionImplBase.this.mCallback.onSkipToNext();
                            }
                        case C0170R.styleable.Theme_colorButtonNormal /*88*/:
                            if ((16 & validActions) != 0) {
                                MediaSessionImplBase.this.mCallback.onSkipToPrevious();
                            }
                        case C0170R.styleable.Theme_colorSwitchThumbNormal /*89*/:
                            if ((8 & validActions) != 0) {
                                MediaSessionImplBase.this.mCallback.onRewind();
                            }
                        case C0170R.styleable.Theme_controlBackground /*90*/:
        ...
        public MediaSessionImplBase(Context context, String tag, ComponentName mbrComponent, PendingIntent mbr) {
            ...
            this.mVolumeCallback = new C00661();
        ...
        public void setCallback(Callback callback, Handler handler) {
            if (callback != this.mCallback) {
                if (callback == null || VERSION.SDK_INT < 18) {
                    ...
                    Callback cb14 = new C00672(callback);
                    if (VERSION.SDK_INT >= 18) {
    ...
    public static final class QueueItem implements Parcelable {
        ...
        static class C00681 implements Creator<QueueItem> {
            ...
            public final QueueItem createFromParcel(Parcel p) {
                return new QueueItem(null);
            }

            public final QueueItem[] newArray(int size) {
    ...
    static final class ResultReceiverWrapper implements Parcelable {
        ...
        static class C00691 implements Creator<ResultReceiverWrapper> {
            ...
            public final ResultReceiverWrapper createFromParcel(Parcel p) {
                return new ResultReceiverWrapper(p);
            }

            public final ResultReceiverWrapper[] newArray(int size) {
