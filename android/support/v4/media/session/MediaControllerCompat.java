...
public final class MediaControllerCompat {
    ...
    public final void setVolumeTo(int value, int flags) {
        this.mImpl.setVolumeTo(value, flags);
    }

    public final void adjustVolume(int direction, int flags) {
    ...
    public final void sendCommand(String command, Bundle params, ResultReceiver cb) {
