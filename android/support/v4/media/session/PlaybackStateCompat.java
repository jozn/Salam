...
public final class PlaybackStateCompat implements Parcelable {
    ...
    static class C00721 implements Creator<PlaybackStateCompat> {
        ...
        public final PlaybackStateCompat createFromParcel(Parcel in) {
            return new PlaybackStateCompat(null);
        }

        public final PlaybackStateCompat[] newArray(int size) {
    ...
    public static final class Builder {
        ...
        public final Builder setState(int state, long position, float playbackSpeed) {
            return setState(state, position, playbackSpeed, SystemClock.elapsedRealtime());
        }

        public final Builder setState(int state, long position, float playbackSpeed, long updateTime) {
            this.mState = state;
        ...
        public final Builder setBufferedPosition(long bufferPosition) {
            this.mBufferedPosition = bufferPosition;
            return this;
        }

        public final Builder setActions(long capabilities) {
            this.mActions = capabilities;
            return this;
        }

        public final Builder addCustomAction(String action, String name, int icon) {
        ...
        public final Builder setActiveQueueItemId(long id) {
            this.mActiveItemId = id;
            return this;
        }

        public final Builder setErrorMessage(CharSequence errorMessage) {
    ...
    public static final class CustomAction implements Parcelable {
        ...
        static class C00731 implements Creator<CustomAction> {
            ...
            public final CustomAction createFromParcel(Parcel p) {
                return new CustomAction(null);
            }

            public final CustomAction[] newArray(int size) {
