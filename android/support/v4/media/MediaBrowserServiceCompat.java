...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    class C00443 extends Result<List<MediaItem>> {
        final /* synthetic */ ConnectionRecord val$connection;
        final /* synthetic */ String val$parentId;

        C00443(Object x0, String str, ConnectionRecord connectionRecord) {
            this.val$parentId = str;
    ...
    class C00454 extends Result<MediaItem> {
        final /* synthetic */ ResultReceiver val$receiver;

        C00454(Object x0, ResultReceiver resultReceiver) {
    ...
    private class ServiceBinder extends Stub {
        ...
        class C00461 implements Runnable {
            ...
            C00461(IMediaBrowserServiceCompatCallbacks iMediaBrowserServiceCompatCallbacks, String str, Bundle bundle, int i) {
        ...
        class C00472 implements Runnable {
            ...
            C00472(IMediaBrowserServiceCompatCallbacks iMediaBrowserServiceCompatCallbacks) {
                this.val$callbacks = iMediaBrowserServiceCompatCallbacks;
            }
        ...
        class C00483 implements Runnable {
            ...
            C00483(IMediaBrowserServiceCompatCallbacks iMediaBrowserServiceCompatCallbacks, String str) {
                this.val$callbacks = iMediaBrowserServiceCompatCallbacks;
                this.val$id = str;
            }
        ...
        class C00494 implements Runnable {
            ...
            C00494(IMediaBrowserServiceCompatCallbacks iMediaBrowserServiceCompatCallbacks, String str) {
                this.val$callbacks = iMediaBrowserServiceCompatCallbacks;
                this.val$id = str;
            }
        ...
        class C00505 implements Runnable {
            ...
            C00505(String str, ResultReceiver resultReceiver) {
        ...
        public void connect(String pkg, Bundle rootHints, IMediaBrowserServiceCompatCallbacks callbacks) {
            ...
            if (MediaBrowserServiceCompat.this.isValidPackage(pkg, uid)) {
                MediaBrowserServiceCompat.this.mHandler.post(new C00461(callbacks, pkg, rootHints, uid));
                return;
            }
        ...
        public void disconnect(IMediaBrowserServiceCompatCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.post(new C00472(callbacks));
        }

        public void addSubscription(String id, IMediaBrowserServiceCompatCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.post(new C00483(callbacks, id));
        }

        public void removeSubscription(String id, IMediaBrowserServiceCompatCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.post(new C00494(callbacks, id));
        }

        public void getMediaItem(String mediaId, ResultReceiver receiver) {
            if (!TextUtils.isEmpty(mediaId) && receiver != null) {
                MediaBrowserServiceCompat.this.mHandler.post(new C00505(mediaId, receiver));
            }
        }
    }
    ...
    public void setSessionToken(Token token) {
        if (token == null) {
            ...
            this.mSession = token;
            this.mHandler.post(new C00421(token));
        }
    }
    ...
    public void notifyChildrenChanged(@NonNull String parentId) {
        ...
        this.mHandler.post(new C00432(parentId));
    }
    ...
    private void performLoadChildren(String parentId, ConnectionRecord connection) {
        Result<List<MediaItem>> result = new C00443(parentId, parentId, connection);
    ...
    private void performLoadItem(String itemId, ResultReceiver receiver) {
        Result<MediaItem> result = new C00454(itemId, receiver);
