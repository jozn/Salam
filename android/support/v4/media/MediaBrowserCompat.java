...
public final class MediaBrowserCompat {
    ...
    static class MediaBrowserImplBase {
        ...
        class C00341 implements Runnable {
            ...
            C00341(ServiceConnection serviceConnection) {
        ...
        class C00352 implements Runnable {
            ...
            C00352(ItemCallback itemCallback, String str) {
        ...
        class C00363 extends ResultReceiver {
            final /* synthetic */ ItemCallback val$cb;
            final /* synthetic */ String val$mediaId;

            C00363(Handler x0, ItemCallback itemCallback, String str) {
                this.val$cb = itemCallback;
                this.val$mediaId = str;
                super(x0);
            }
        ...
        class C00374 implements Runnable {
            final /* synthetic */ ItemCallback val$cb;
            final /* synthetic */ String val$mediaId;

            C00374(ItemCallback itemCallback, String str) {
                this.val$cb = itemCallback;
                this.val$mediaId = str;
            }
        ...
        class C00385 implements Runnable {
            ...
            C00385(IMediaBrowserServiceCompatCallbacks iMediaBrowserServiceCompatCallbacks, String str, Token token, Bundle bundle) {
        ...
        class C00396 implements Runnable {
            final /* synthetic */ IMediaBrowserServiceCompatCallbacks val$callback;

            C00396(IMediaBrowserServiceCompatCallbacks iMediaBrowserServiceCompatCallbacks) {
                this.val$callback = iMediaBrowserServiceCompatCallbacks;
            }
        ...
        class C00407 implements Runnable {
            ...
            C00407(IMediaBrowserServiceCompatCallbacks iMediaBrowserServiceCompatCallbacks, List list, String str) {
                this.val$callback = iMediaBrowserServiceCompatCallbacks;
                this.val$list = list;
        ...
        public void connect() {
            if (this.mState != 0) {
                ...
                if (!bound) {
                    this.mHandler.post(new C00341(thisConnection));
                }
            }
        }
        ...
        public void subscribe(@NonNull String parentId, @NonNull SubscriptionCallback callback) {
            if (parentId == null) {
                ...
                if ((sub == null ? CONNECT_STATE_CONNECTING : null) != null) {
        ...
        public void getItem(@NonNull String mediaId, @NonNull ItemCallback cb) {
            if (TextUtils.isEmpty(mediaId)) {
                ...
                this.mHandler.post(new C00352(cb, mediaId));
            } else {
                try {
                    this.mServiceBinder.getMediaItem(mediaId, new C00363(this.mHandler, cb, mediaId));
                } catch (RemoteException e) {
                    Log.i(TAG, "Remote error getting media item.");
                    this.mHandler.post(new C00374(cb, mediaId));
                }
            }
        }
    ...
    public static class MediaItem implements Parcelable {
        ...
        static class C00411 implements Creator<MediaItem> {
            ...
            public final MediaItem[] newArray(int size) {
    ...
    public final void subscribe(@NonNull String parentId, @NonNull SubscriptionCallback callback) {
        this.mImpl.subscribe(parentId, callback);
    }

    public final void unsubscribe(@NonNull String parentId) {
        this.mImpl.unsubscribe(parentId);
    }

    public final void getItem(@NonNull String mediaId, @NonNull ItemCallback cb) {
