...
class AppCompatDelegateImplV7 extends AppCompatDelegateImplBase implements LayoutInflaterFactory, Callback {
    ...
    class C01541 implements Runnable {
        ...
        public void run() {
            ...
            if ((AppCompatDelegateImplV7.this.mInvalidatePanelMenuFeatures & AccessibilityNodeInfoCompat.ACTION_SCROLL_FORWARD) != 0) {
                AppCompatDelegateImplV7.this.doInvalidatePanelMenu(C0170R.styleable.Theme_spinnerStyle);
            }
    ...
    class C01552 implements OnApplyWindowInsetsListener {
        C01552() {
        }
    ...
    class C01563 implements OnFitSystemWindowsListener {
        C01563() {
        }
    ...
    class C01574 implements OnAttachListener {
        C01574() {
        }
    ...
    class C01595 implements Runnable {
        ...
        class C01581 extends ViewPropertyAnimatorListenerAdapter {
            C01581() {
            }
        ...
        public void run() {
            ...
            AppCompatDelegateImplV7.this.mFadeAnim.setListener(new C01581());
        }
    }

    /* renamed from: android.support.v7.app.AppCompatDelegateImplV7.6 */
    class C01606 extends ViewPropertyAnimatorListenerAdapter {
        C01606() {
        }
    ...
    private final class ActionMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public final boolean onOpenSubMenu(MenuBuilder subMenu) {
            ...
            if (cb != null) {
                cb.onMenuOpened(C0170R.styleable.Theme_spinnerStyle, subMenu);
            }
            return true;
        }
    ...
    class ActionModeCallbackWrapperV7 implements ActionMode.Callback {
        ...
        class C01611 extends ViewPropertyAnimatorListenerAdapter {
            C01611() {
            }
        ...
        public void onDestroyActionMode(ActionMode mode) {
            ...
            if (AppCompatDelegateImplV7.this.mActionModeView != null) {
                ...
                AppCompatDelegateImplV7.this.mFadeAnim.setListener(new C01611());
            }
    ...
    private static final class PanelFeatureState {
        ...
        final void setStyle(Context context) {
            ...
            TypedArray a = context2.obtainStyledAttributes(C0170R.styleable.Theme);
            this.background = a.getResourceId(C0170R.styleable.Theme_panelBackground, 0);
            this.windowAnimations = a.getResourceId(C0170R.styleable.Theme_android_windowAnimationStyle, 0);
            a.recycle();
        }
        ...
        final MenuView getListMenuView(MenuPresenter.Callback cb) {
            if (this.menu == null) {
                return null;
            }
        ...
        final void onRestoreInstanceState(Parcelable state) {
    ...
    AppCompatDelegateImplV7(Context context, Window window, AppCompatCallback callback) {
        ...
        this.mFadeAnim = null;
        this.mInvalidatePanelMenuRunnable = new C01541();
    }
        ...
        if (!this.mSubDecorInstalled) {
            ...
            if (!isDestroyed()) {
                if (st == null || st.menu == null) {
                    invalidatePanelMenu(C0170R.styleable.Theme_spinnerStyle);
                }
            }
        }
    }
    ...
    private ViewGroup createSubDecor() {
        TypedArray a = this.mContext.obtainStyledAttributes(C0170R.styleable.Theme);
        if (a.hasValue(C0170R.styleable.Theme_windowActionBar)) {
            if (a.getBoolean(C0170R.styleable.Theme_windowNoTitle, false)) {
                requestWindowFeature(1);
            } else if (a.getBoolean(C0170R.styleable.Theme_windowActionBar, false)) {
                requestWindowFeature(C0170R.styleable.Theme_spinnerStyle);
            }
            if (a.getBoolean(C0170R.styleable.Theme_windowActionBarOverlay, false)) {
                requestWindowFeature(C0170R.styleable.Theme_switchStyle);
            }
            if (a.getBoolean(C0170R.styleable.Theme_windowActionModeOverlay, false)) {
                requestWindowFeature(10);
            }
            this.mIsFloating = a.getBoolean(C0170R.styleable.Theme_android_windowIsFloating, false);
            a.recycle();
            ...
            if (this.mWindowNoTitle) {
                ...
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(subDecor, new C01552());
                } else {
                    ((FitWindowsViewGroup) subDecor).setOnFitSystemWindowsListener(new C01563());
                }
                ...
                if (this.mOverlayActionBar) {
                    this.mDecorContentParent.initFeature(C0170R.styleable.Theme_switchStyle);
                }
            ...
            ContentFrameLayout abcContent = (ContentFrameLayout) subDecor.findViewById(C0170R.id.action_bar_activity_content);
            ...
            abcContent.setAttachListener(new C01574());
            return subDecor;
        }
        a.recycle();
    ...
    private void applyFixedSizeWindow() {
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(C0170R.styleable.Theme);
        a.getValue(C0170R.styleable.Theme_windowMinWidthMajor, cfl.getMinWidthMajor());
        a.getValue(C0170R.styleable.Theme_windowMinWidthMinor, cfl.getMinWidthMinor());
        if (a.hasValue(C0170R.styleable.Theme_windowFixedWidthMajor)) {
            a.getValue(C0170R.styleable.Theme_windowFixedWidthMajor, cfl.getFixedWidthMajor());
        }
        if (a.hasValue(C0170R.styleable.Theme_windowFixedWidthMinor)) {
            a.getValue(C0170R.styleable.Theme_windowFixedWidthMinor, cfl.getFixedWidthMinor());
        }
        if (a.hasValue(C0170R.styleable.Theme_windowFixedHeightMajor)) {
            a.getValue(C0170R.styleable.Theme_windowFixedHeightMajor, cfl.getFixedHeightMajor());
        }
        if (a.hasValue(C0170R.styleable.Theme_windowFixedHeightMinor)) {
            a.getValue(C0170R.styleable.Theme_windowFixedHeightMinor, cfl.getFixedHeightMinor());
        }
        a.recycle();
        cfl.requestLayout();
    }
    ...
    public boolean requestWindowFeature(int featureId) {
        ...
        if (this.mWindowNoTitle && featureId == C0170R.styleable.Theme_spinnerStyle) {
            return false;
        }
        ...
        switch (featureId) {
            ...
            case C0473R.styleable.SwitchButton_onColor /*10*/:
                ...
                return true;
            case C0170R.styleable.Theme_spinnerStyle /*108*/:
                throwFeatureRequestIfSubDecorInstalled();
                this.mHasActionBar = true;
                return true;
            case C0170R.styleable.Theme_switchStyle /*109*/:
                throwFeatureRequestIfSubDecorInstalled();
    ...
    void onPanelClosed(int featureId, Menu menu) {
        if (featureId == C0170R.styleable.Theme_spinnerStyle) {
            ActionBar ab = getSupportActionBar();
            if (ab != null) {
        ...
        if (mode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    this.mShowActionModePopup = new C01595();
                } else {
            ...
            if (this.mActionModeView != null) {
                ...
                if (callback.onCreateActionMode(mode, mode.getMenu())) {
                    ...
                    this.mFadeAnim.setListener(new C01606());
                    if (this.mActionModePopup != null) {
    ...
    private void reopenMenu(MenuBuilder menu, boolean toggleMenuMode) {
        ...
        if (this.mDecorContentParent.isOverflowMenuShowing() && toggleMenuMode) {
            ...
            if (!isDestroyed()) {
                cb.onPanelClosed(C0170R.styleable.Theme_spinnerStyle, getPanelState(0, true).menu);
            }
            ...
            if (st.menu != null && !st.refreshMenuContent && cb.onPreparePanel(0, st.createdPanelView, st.menu)) {
                cb.onMenuOpened(C0170R.styleable.Theme_spinnerStyle, st.menu);
    ...
    private boolean initializePanelMenu(PanelFeatureState st) {
        Context context = this.mContext;
        if ((st.featureId == 0 || st.featureId == C0170R.styleable.Theme_spinnerStyle) && this.mDecorContentParent != null) {
            TypedValue outValue = new TypedValue();
    ...
    private boolean preparePanel(PanelFeatureState st, KeyEvent event) {
        ...
        if (st.featureId == 0 || st.featureId == C0170R.styleable.Theme_spinnerStyle) {
    ...
    private void checkCloseActionMenu(MenuBuilder menu) {
        if (!this.mClosingActionMenu) {
            ...
            Window.Callback cb = getWindowCallback();
            if (!(cb == null || isDestroyed())) {
                cb.onPanelClosed(C0170R.styleable.Theme_spinnerStyle, menu);
            }
    ...
    private void doInvalidatePanelMenu(int featureId) {
        ...
        st.refreshDecorView = true;
        if ((featureId == C0170R.styleable.Theme_spinnerStyle || featureId == 0) && this.mDecorContentParent != null) {
    ...
    private int sanitizeWindowFeatureId(int featureId) {
        if (featureId == 8) {
            ...
            return C0170R.styleable.Theme_spinnerStyle;
        } else if (featureId != 9) {
            return featureId;
        } else {
            Log.i("AppCompatDelegate", "You should now use the AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR_OVERLAY id when requesting this feature.");
            return C0170R.styleable.Theme_switchStyle;
        }
    }
