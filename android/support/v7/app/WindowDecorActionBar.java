...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    class C01682 extends ViewPropertyAnimatorListenerAdapter {
        C01682() {
        }
    ...
    class C01693 implements ViewPropertyAnimatorUpdateListener {
        C01693() {
        }
    ...
    public WindowDecorActionBar(Activity activity, boolean overlayMode) {
        ...
        this.mHideListener = new C01671();
        this.mShowListener = new C01682();
        this.mUpdateListener = new C01693();
    ...
    private void init(View decor) {
        ...
        if (a.getBoolean(C0170R.styleable.ActionBar_hideOnContentScroll, ALLOW_SHOW_HIDE_ANIMATIONS)) {
