...
class ToolbarActionBar extends ActionBar {
    ...
    class C01652 implements OnMenuItemClickListener {
        C01652() {
        }
    ...
    private final class ActionMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public final boolean onOpenSubMenu(MenuBuilder subMenu) {
            ...
            ToolbarActionBar.this.mWindowCallback.onMenuOpened(C0170R.styleable.Theme_spinnerStyle, subMenu);
            return true;
        }
        ...
        public final void onCloseMenu(MenuBuilder menu, boolean allMenusAreClosing) {
            if (!this.mClosingActionMenu) {
                ...
                if (ToolbarActionBar.this.mWindowCallback != null) {
                    ToolbarActionBar.this.mWindowCallback.onPanelClosed(C0170R.styleable.Theme_spinnerStyle, menu);
                }
    ...
    private final class MenuBuilderCallback implements MenuBuilder.Callback {
        ...
        public final void onMenuModeChange(MenuBuilder menu) {
            ...
            if (ToolbarActionBar.this.mDecorToolbar.isOverflowMenuShowing()) {
                ...
                ToolbarActionBar.this.mWindowCallback.onMenuOpened(C0170R.styleable.Theme_spinnerStyle, menu);
            }
        }
    }
    ...
    public ToolbarActionBar(Toolbar toolbar, CharSequence title, Callback callback) {
        ...
        this.mMenuInvalidator = new C01641();
        this.mMenuClicker = new C01652();
