...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mSearchPlate.setBackgroundDrawable(a.getDrawable(C0170R.styleable.SearchView_queryBackground));
        this.mSubmitArea.setBackgroundDrawable(a.getDrawable(C0170R.styleable.SearchView_submitBackground));
    ...
    L_0x0009:
        return;
    L_0x000a:
        r1 = android.view.View.MeasureSpec.getMode(r4);
        r0 = android.view.View.MeasureSpec.getSize(r4);
        switch(r1) {
            case -2147483648: goto L_0x001f;
            case 0: goto L_0x003e;
            case 1073741824: goto L_0x0033;
            default: goto L_0x0015;
        };
    L_0x0015:
        r2 = 1073741824; // 0x40000000 float:2.0 double:5.304989477E-315;
        r2 = android.view.View.MeasureSpec.makeMeasureSpec(r0, r2);
        super.onMeasure(r2, r5);
        goto L_0x0009;
    L_0x001f:
        r2 = r3.mMaxWidth;
    ...
    private void updateSearchAutoComplete() {
        ...
        if ((inputType & 15) == 1) {
            ...
            if (this.mSearchable.getSuggestAuthority() != null) {
                inputType = (AccessibilityNodeInfoCompat.ACTION_CUT | inputType) | AccessibilityNodeInfoCompat.ACTION_COLLAPSE;
            }
        }
        this.mSearchSrcTextView.setInputType(inputType);
    ...
    private Intent createIntentFromSuggestion(Cursor c, int actionKey, String actionMsg) {
        try {
            ...
            if (data != null) {
                ...
                if (id != null) {
                    data = data + MqttTopic.TOPIC_LEVEL_SEPARATOR + Uri.encode(id);
                }
            }
