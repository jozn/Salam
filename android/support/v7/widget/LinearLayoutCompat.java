...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public LinearLayoutCompat(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0170R.styleable.LinearLayoutCompat, defStyleAttr, SHOW_DIVIDER_NONE);
        ...
        this.mShowDividers = a.getInt(C0170R.styleable.LinearLayoutCompat_showDividers, SHOW_DIVIDER_NONE);
        this.mDividerPadding = a.getDimensionPixelSize(C0170R.styleable.LinearLayoutCompat_dividerPadding, SHOW_DIVIDER_NONE);
        a.recycle();
    }
    ...
    void measureVertical(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int delta = (ViewCompat.MEASURED_SIZE_MASK & heightSizeAndState) - this.mTotalLength;
        ...
        setMeasuredDimension(ViewCompat.resolveSizeAndState(Math.max((getPaddingLeft() + getPaddingRight()) + maxWidth, getSuggestedMinimumWidth()), widthMeasureSpec, childState), heightSizeAndState);
        if (matchWidth) {
    ...
    void measureHorizontal(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int delta = (ViewCompat.MEASURED_SIZE_MASK & widthSizeAndState) - this.mTotalLength;
        if (skippedMeasure || (delta != 0 && totalWeight > 0.0f)) {
            float weightSum;
            if (this.mWeightSum > 0.0f) {
                weightSum = this.mWeightSum;
        ...
        setMeasuredDimension((ViewCompat.MEASURED_STATE_MASK & childState) | widthSizeAndState, ViewCompat.resolveSizeAndState(Math.max((getPaddingTop() + getPaddingBottom()) + maxHeight, getSuggestedMinimumHeight()), heightMeasureSpec, childState << 16));
        if (matchHeight) {
