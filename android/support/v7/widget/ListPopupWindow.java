...
public class ListPopupWindow {
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            if (!wasForwarding) {
                ...
                if (forwarding) {
                    ...
                    MotionEvent e = MotionEvent.obtain(uptimeMillis, uptimeMillis, 3, 0.0f, 0.0f, ListPopupWindow.POSITION_PROMPT_ABOVE);
    ...
    class C01921 extends ForwardingListener {
        C01921(View x0) {
            super(x0);
        }
    ...
    class C01943 implements OnItemSelectedListener {
        C01943() {
        }
    ...
    private static class DropDownListView extends ListViewCompat {
        ...
        public DropDownListView(Context context, boolean hijackFocus) {
            super(context, null, C0170R.attr.dropDownListViewStyle);
    ...
    public ListPopupWindow(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mDropDownHorizontalOffset = a.getDimensionPixelOffset(C0170R.styleable.ListPopupWindow_android_dropDownHorizontalOffset, POSITION_PROMPT_ABOVE);
        this.mDropDownVerticalOffset = a.getDimensionPixelOffset(C0170R.styleable.ListPopupWindow_android_dropDownVerticalOffset, POSITION_PROMPT_ABOVE);
            ...
            if (!(below && keyCode == 19 && curIndex <= firstItem) && (below || keyCode != 20 || curIndex < lastItem)) {
                ...
                if (this.mDropDownList.onKeyDown(keyCode, event)) {
                    ...
                    switch (keyCode) {
                        ...
                        case C0170R.styleable.Theme_textAppearanceSearchResultSubtitle /*66*/:
                            return true;
                    }
    ...
    private int buildDropDown() {
        ...
        if (this.mDropDownList == null) {
            ...
            this.mShowDropDownRunnable = new C01932();
            ...
            this.mDropDownList.setOnItemSelectedListener(new C01943());
