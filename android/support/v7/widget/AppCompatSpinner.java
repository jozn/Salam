...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    class C01881 extends ForwardingListener {
        final /* synthetic */ DropdownPopup val$popup;

        C01881(View x0, DropdownPopup dropdownPopup) {
    ...
    private class DropdownPopup extends ListPopupWindow {
        ...
        class C01891 implements OnItemClickListener {
            final /* synthetic */ AppCompatSpinner val$this$0;

            C01891(AppCompatSpinner appCompatSpinner) {
        ...
        class C01913 implements OnDismissListener {
            final /* synthetic */ OnGlobalLayoutListener val$layoutListener;

            C01913(OnGlobalLayoutListener onGlobalLayoutListener) {
        ...
        public DropdownPopup(Context context, AttributeSet attrs, int defStyleAttr) {
            ...
            setOnItemClickListener(new C01891(AppCompatSpinner.this));
        }
        ...
        public void show() {
            ...
            if (!wasShowing) {
                ViewTreeObserver vto = AppCompatSpinner.this.getViewTreeObserver();
                if (vto != null) {
                    OnGlobalLayoutListener layoutListener = new C01902();
                    vto.addOnGlobalLayoutListener(layoutListener);
                    setOnDismissListener(new C01913(layoutListener));
                }
            }
        }
    ...
    public AppCompatSpinner(Context context, AttributeSet attrs, int defStyleAttr, int mode, Theme popupTheme) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0170R.styleable.Spinner, defStyleAttr, MODE_DIALOG);
        ...
        if (popupTheme != null) {
            ...
            int popupThemeResId = a.getResourceId(C0170R.styleable.Spinner_popupTheme, MODE_DIALOG);
        ...
        if (this.mPopupContext != null) {
            ...
            if (mode == MODE_DROPDOWN) {
                ...
                TintTypedArray pa = TintTypedArray.obtainStyledAttributes(this.mPopupContext, attrs, C0170R.styleable.Spinner, defStyleAttr, MODE_DIALOG);
                ...
                pa.recycle();
                this.mPopup = popup;
                this.mForwardingListener = new C01881(this, popup);
            }
        }
        a.recycle();
        this.mPopupSet = true;
