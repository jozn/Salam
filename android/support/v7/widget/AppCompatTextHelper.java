...
class AppCompatTextHelper {
    ...
    static {
        ...
        TEXT_APPEARANCE_ATTRS = new int[]{C0170R.attr.textAllCaps};
    }
    ...
    void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        a.recycle();
        if (ap != -1) {
            TypedArray appearance = context.obtainStyledAttributes(ap, C0170R.styleable.TextAppearance);
            if (appearance.hasValue(C0170R.styleable.TextAppearance_textAllCaps)) {
                setAllCaps(appearance.getBoolean(C0170R.styleable.TextAppearance_textAllCaps, false));
            }
            appearance.recycle();
        }
