...
public class AppCompatPopupWindow extends PopupWindow {
    ...
    static class C01871 implements OnScrollChangedListener {
        ...
        C01871(Field field, PopupWindow popupWindow, OnScrollChangedListener onScrollChangedListener) {
    ...
    public AppCompatPopupWindow(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0170R.styleable.PopupWindow, defStyleAttr, 0);
        if (a.hasValue(C0170R.styleable.PopupWindow_overlapAnchor)) {
            setSupportOverlapAnchor(a.getBoolean(C0170R.styleable.PopupWindow_overlapAnchor, COMPAT_OVERLAP_ANCHOR));
        }
        setBackgroundDrawable(a.getDrawable(C0170R.styleable.PopupWindow_android_popupBackground));
        a.recycle();
    ...
    private static void wrapOnScrollChangedListener(PopupWindow popup) {
        try {
            ...
            fieldListener.set(popup, new C01871(fieldAnchor, popup, (OnScrollChangedListener) fieldListener.get(popup)));
        } catch (Exception e) {
