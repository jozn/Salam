...
class ActionMenuPresenter extends BaseMenuPresenter implements SubUiVisibilityListener {
    ...
    private class ActionButtonSubmenu extends MenuPopupHelper {
        ...
        public ActionButtonSubmenu(Context context, SubMenuBuilder subMenu) {
            super(context, subMenu, null, false, C0170R.attr.actionOverflowMenuStyle);
    ...
    private class OverflowMenuButton extends AppCompatImageView implements ActionMenuChildView {
        ...
        class C01791 extends ForwardingListener {
            final /* synthetic */ ActionMenuPresenter val$this$0;

            C01791(View x0, ActionMenuPresenter actionMenuPresenter) {
        ...
        public OverflowMenuButton(Context context) {
            ...
            setVisibility(0);
            setEnabled(true);
            setOnTouchListener(new C01791(this, ActionMenuPresenter.this));
        }
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        if (!this.mMaxItemsSet) {
            this.mMaxItems = this.mContext.getResources().getInteger(C0170R.integer.abc_max_action_buttons);
        }
        if (this.mMenu != null) {
