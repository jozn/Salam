...
public class ActionBarOverlayLayout extends ViewGroup implements NestedScrollingParent, DecorContentParent {
    ...
    class C01751 extends ViewPropertyAnimatorListenerAdapter {
        C01751() {
        }
    ...
    static {
        ATTRS = new int[]{C0170R.attr.actionBarSize, 16842841};
    }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C01751();
        this.mRemoveActionBarHideOffset = new C01762();
        this.mAddActionBarHideOffset = new C01773();
        init(context);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(ViewCompat.resolveSizeAndState(Math.max(maxWidth + (getPaddingLeft() + getPaddingRight()), getSuggestedMinimumWidth()), widthMeasureSpec, childState), ViewCompat.resolveSizeAndState(Math.max((getPaddingTop() + getPaddingBottom()) + maxHeight, getSuggestedMinimumHeight()), heightMeasureSpec, childState << 16));
    }
    ...
    private boolean shouldHideActionBarOnFling(float velocityX, float velocityY) {
        this.mFlingEstimator.fling(0, 0, 0, (int) velocityY, 0, 0, RtlSpacingHelper.UNDEFINED, ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
