...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean style) {
        this(toolbar, style, C0170R.string.abc_action_bar_up_description, C0170R.drawable.abc_ic_ab_back_mtrl_am_alpha);
    }
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean style, int defaultNavigationContentDescription, int defaultNavigationIcon) {
        ...
        if (style) {
            ...
            Drawable navIcon = a.getDrawable(C0170R.styleable.ActionBar_homeAsUpIndicator);
            if (navIcon != null) {
        ...
        this.mToolbar.setNavigationOnClickListener(new C02121());
    }
