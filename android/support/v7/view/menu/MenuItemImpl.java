...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    public final MenuItem setCallback(Runnable callback) {
    ...
    final void setMenuInfo(ContextMenuInfo menuInfo) {
    ...
    public final SupportMenuItem setActionView(int resId) {
    ...
    public final SupportMenuItem setShowAsActionFlags(int actionEnum) {
