...
public class MenuPopupHelper implements MenuPresenter, OnKeyListener, OnGlobalLayoutListener, OnItemClickListener, OnDismissListener {
    ...
    static {
        ITEM_LAYOUT = C0170R.layout.abc_popup_menu_item_layout;
    }

    public MenuPopupHelper(Context context, MenuBuilder menu) {
        this(context, menu, null, false, C0170R.attr.popupMenuStyle);
    }

    public MenuPopupHelper(Context context, MenuBuilder menu, View anchorView) {
        this(context, menu, anchorView, false, C0170R.attr.popupMenuStyle);
    }
