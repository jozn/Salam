...
public final class Spdy3 implements Variant {
    ...
    static final class Reader implements FrameReader {
        ...
        public final boolean nextFrame(Handler handler) throws IOException {
            ...
            try {
                ...
                if ((RtlSpacingHelper.UNDEFINED & w1) != 0) {
                    control = true;
                } else {
                    control = false;
                }
    ...
    static final class Writer implements FrameWriter {
        ...
        public final void pushPromise(int streamId, int promisedStreamId, List<Header> list) throws IOException {
        }
        ...
        final void sendDataFrame(int streamId, int flags, Buffer buffer, int byteCount) throws IOException {
            if (this.closed) {
                throw new IOException("closed");
        ...
        private void writeNameValueBlockToBuffer(List<Header> headerBlock) throws IOException {
            ...
            for (int i = Spdy3.TYPE_DATA; i < size; i += Spdy3.TYPE_SYN_STREAM) {
                ...
                this.headerBlockOut.writeInt(name.data.length);
                this.headerBlockOut.write(name);
                ByteString value = ((Header) headerBlock.get(i)).value;
                this.headerBlockOut.writeInt(value.data.length);
