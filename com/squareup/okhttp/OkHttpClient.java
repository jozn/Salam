...
public class OkHttpClient implements Cloneable {
    ...
    static class C11911 extends Internal {
        C11911() {
        }
        ...
        public final void closeIfOwnedBy(Connection connection, Object owner) throws IOException {
        ...
        public final boolean isReadable(Connection pooled) {
        ...
        public final void setCache(OkHttpClient client, InternalCache internalCache) {
        ...
        public final void recycle(ConnectionPool pool, Connection connection) {
            pool.recycle(connection);
        }

        public final RouteDatabase routeDatabase(OkHttpClient client) {
            return client.routeDatabase();
        }

        public final Network network(OkHttpClient client) {
            return client.network;
        }

        public final void setNetwork(OkHttpClient client, Network network) {
            client.network = network;
        }

        public final void connectAndSetOwner(OkHttpClient client, Connection connection, HttpEngine owner, Request request) throws IOException {
            connection.connectAndSetOwner(client, owner, request);
        }

        public final void callEnqueue(Call call, Callback responseCallback, boolean forWebSocket) {
        ...
        public final void connectionSetOwner(Connection connection, Object owner) {
