...
public final class ChatMessagesDBLoadJob extends Job {
    ...
    public ChatMessagesDBLoadJob(String threadId, int currentLoadedIndex) {
        ...
        this.currentLoadedIndex = currentLoadedIndex;
    }
        ...
        if (this.id == jobCounter.get()) {
            ...
            if (me != null) {
                ...
                try {
                    ...
                    EventBus.getDefault().postSticky(new ChatMessagesDBLoadCompletedEvent(this.threadId, listMsg));
                } catch (Throwable th) {
                    cursor.close();
                }
            }
        ...
        try {
            ...
            if (friendCursor != null && friendCursor.getCount() == 1) {
                ...
                try {
                    ...
                    user2.myStatus = friendCursor.getString(friendCursor.getColumnIndex("myStatus"));
                    user2.mobileNo = friendCursor.getString(friendCursor.getColumnIndex("mobileNo"));
                    user2.profileImageUrl = friendCursor.getString(friendCursor.getColumnIndex("profileimage_url"));
                    if (rosterCursor != null && rosterCursor.getCount() > 0) {
                        ...
                        user2.statusMode = rosterCursor.getInt(rosterCursor.getColumnIndex("status_mode"));
                        user2.myStatus = rosterCursor.getString(rosterCursor.getColumnIndex("status_message"));
                    }
                    if (friendCursor.getInt(friendCursor.getColumnIndex("user_type")) == 2) {
                        user2.isInChat = BooleanStatus.TRUE;
                    } else {
                        user2.isInChat = BooleanStatus.FALSE;
                    }
                    user2.gender = friendCursor.getString(friendCursor.getColumnIndex("gender"));
                    user2.cityOrRegion = friendCursor.getString(friendCursor.getColumnIndex("region"));
