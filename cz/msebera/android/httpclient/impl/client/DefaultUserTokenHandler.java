...
public final class DefaultUserTokenHandler implements UserTokenHandler {
    ...
    public final Object getUserToken(HttpContext context) {
    ...
    private static Principal getAuthPrincipal(AuthState authState) {
        AuthScheme scheme = authState.authScheme;
